...
LABEL "org.opencontainers.image.version"="0.142.0"
LABEL "org.opencontainers.image.revision"="d98cbdf5814582ffdb99501f750a502f2c4fcd3c"
...
RUN jar xf jbang-0.142.0.zip && \
    rm jbang-0.142.0.zip && \
    mv jbang-* jbang && \
